...
import { FlipWords } from "./ui/flips-word";
...
export default function Hero() {
  const words = ["Stories", "Moments", "Creativity", "Experiences"];
    ...
    <>
      ...
      >
        ...
        <div className="absolute w-full h-full -bottom-80 z-10">
          ...
          <div className="absolute inset-0 z-20 pointer-events-none bg-gradient-to-t from-background via-background/80 to-transparent" />
        </div>
        <BackgroundBeams />
        ...
        <div className="container px-4 md:px-6 relative z-10 w-full">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              >
                Connecting People Through Shared <FlipWords words={words} />
              </h1>
              <p
                ref={textRef}
